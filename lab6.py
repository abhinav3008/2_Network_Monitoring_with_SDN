    ...
    def _port_stats_reply_handler(self, ev):
        ...
        for stat in sorted(body, key=attrgetter('port_no')):
            ...
            with open('stats.csv', 'a') as myFile:
                myFile.write(str(ev.msg.datapath.id)+','+str(stat.port_no)+','+str(stat.rx_packets)+','+str(stat.rx_bytes)+','+str(stat.rx_errors)+','+str(stat.tx_packets)+','+str(stat.tx_bytes)+','+str(stat.tx_errors)+'\n')
